...
def parse_args():
    ...
    argparser.add_argument("--store-rules", type=argparse.FileType('w'),
                           help="File to store the rules used to generate training data by gen-subdominization-training")
